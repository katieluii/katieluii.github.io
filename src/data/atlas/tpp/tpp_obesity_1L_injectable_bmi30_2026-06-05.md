...
- **Neuropsychiatric / suicidality:** GLP-1 class signal under active FDA observation (evidence conflicting — antidepressant-like benefit vs suicidality reports, as of 2026-06). Any new GLP-1R-mechanism asset should plan prospective neuropsychiatric capture.
...
- No ADC AA-pathway analogue exists in this class (0 AA-pathway assets in the obesity landscape).
