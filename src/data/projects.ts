...
export const projects: Project[] = [
  ...
  },
 {
  ...
  },
  {
    ...
    title: "Atlas — Strategic memory for drug development",
    themes: ["AI/ML & Automation", "Biopharma Strategy"],
    status: "Live",
    yearStart: 2026,
    yearEnd: 2026,
    ...
    longDescription: "Atlas holds a living strategic memory per indication — the Emerging Therapeutic Landscape Map (ETLM) — built from clinical registries, peer-reviewed literature, trade press, and conference readouts. From that memory it generates the strategic outputs your team needs, and returns evidence-anchored verdicts to strategic questions with the citations already organised. The output is a decision, not a reading list.",
