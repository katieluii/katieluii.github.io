...
export const suite: SuiteProduct[] = [
  {
    ...
    job: 'A live landscape map per indication, built from primary sources on trials, readouts and regulatory moves, and analyst-reviewed.',
    status: 'Live',
  ...
  },
  {
    ...
    job: 'Routes each large-cap pharma to the valuation model that fits it, on one comparable view. Refreshed quarterly, reviewed before it ships.',
    status: 'Live',
  ...
  },
  {
    ...
    job: 'Diligence and deal-flow tooling: investment memos, holdings and financing trackers, deal monitoring. Home of the AI-native VC offering.',
    status: 'Live',
  ...
  },
  {
    ...
    job: 'Scores every company at BIO, JPM or BioEquity against your angle, shows the reasoning per row, and drafts the first note. Live on BIO 2026.',
    status: 'Live',
