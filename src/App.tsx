    ...
    <Router>
      <Routes>
        ...
        {/* WS15: Work with me — hub chooser + two distinct audience pages.
            Gated OFF the live site via WWM_LIVE (src/data/atlas/copy.ts) pending Katie's
            review + the corpus-wide stale-data audit. Flip WWM_LIVE → true to relaunch
            these routes AND light the Atlas page's "Work with me" CTA together. */}
        {WWM_LIVE && (
          <>
